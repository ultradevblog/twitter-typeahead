...
$('.typeahead').typeahead({
  ...
  limit:maxresults,
   ...
   empty: [
	...
	header:
	function (value) {
	return '<div align="left"><font size=2.5><table style="width:100%"><tr><td><span class="suggestion-dropdown">&nbsp;Movie</td><td align="right"><font class="suggestion-dropdown">Popularity&nbsp;</font></td> </tr></table><hr>'
    },
	footer:
	function (value) {
